...
static const uint8_t _hidReportDescriptor[] = {
  ...
  REPORT_SIZE(1),     0x08,          //   REPORT_SIZE(8)
  LOGICAL_MINIMUM(1), 0x00,          //   LOGICAL_MINIMUM(0)
  LOGICAL_MAXIMUM(1), 0xDD,          //   LOGICAL_MAXIMUM(0x65→0xDD)
  USAGE_PAGE(1),      0x07,          //   USAGE_PAGE (Kbrd/Keypad)
  USAGE_MINIMUM(1),   0x00,          //   USAGE_MINIMUM (0)
  USAGE_MAXIMUM(1),   0xDD,          //   USAGE_MAXIMUM (0x65→0xDD)
...
// pressRaw() is almost the same as press(). But arg k is regarded as Usage ID of HID
// Usage ID: https://www.usb.org/sites/default/files/documents/hut1_12v2.pdf pp.53
...
// releaseRaw() is almost the same as release(). But arg k is regarded as Usage ID of HID
